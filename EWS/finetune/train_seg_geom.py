...
from model_unet_mae_geom import build_model_from_mae_ckpt
...
def main():
    ...
    p.add_argument('--mae_ckpt', type=str, required=True, help='mae2d_geom_best.pt or geom epoch checkpoint')
    p.add_argument('--out_dir', type=str, default='', help='Where to save finetuned weights; default finetune_seg_ckpts_geom')
    ...
    p.add_argument('--log_csv', type=str, default='', help='Metrics CSV (default: EWS/finetune/segmentation_training_log_geom.csv)')
    args = p.parse_args()
