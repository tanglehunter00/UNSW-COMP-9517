"""EWS 2D MAE pretraining with geometric prior bias on attention (separate from vanilla mae2d)."""
...
def parse_args():
    ...
    p.add_argument(
        "--no_geom_bias",
        action="store_true",
        help="Disable distance-based attention bias (ablation; same stack as vanilla MHA).",
    )
    p.add_argument(
        "--device",
        type=str,
